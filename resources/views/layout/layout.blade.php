        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title">&nbsp;<i class="fa fa-tint"></i> &nbsp;&nbsp;<span>恒源水站</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-users"></i>用户管理<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ url('userList') }}">用户列表</a></li>
                      <li><a href="{{ url('addUser') }}">添加用户</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-globe"></i>商品管理<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ url('goods') }}">商品列表</a></li>
                      <li><a href="{{ url('goods/create') }}">添加商品</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-truck"></i> 供应商管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ url('supplier') }}">供应商列表</a></li>
                      <li><a href="{{ url('supplier/create') }}">添加供应商</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-user"></i> 管理员管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ url('admin/addAdmin') }}">添加管理员</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <!-- <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="{{ url('outLogin') }}">退出</a></li>
                  <!-- </ul>
                </li> -->
