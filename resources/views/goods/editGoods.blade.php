      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" action="/goods/{{ $goods_info->id }}" method="post">
            	{{ csrf_field() }}
            	{{ method_field('PUT') }}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text"  name="cost_price"  required="required" class="form-control col-md-7 col-xs-12" value="{{ $goods_info->cost_price }}">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">零售价</label>
                <div class="col-md-6 col-sm-9 col-xs-12">
                	<input type="text"  name="price"  required="required" class="form-control col-md-7 col-xs-12" value="{{ $goods_info->price }}">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">会员价</label>
                <div class="col-md-6 col-sm-9 col-xs-12">
                  <input type="text"  name="vip_price"  required="required" class="form-control col-md-7 col-xs-12" value="{{ $goods_info->vip_price }}">
                </div>
              </div>
              <div class="form-group">
