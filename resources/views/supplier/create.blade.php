      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" action="{{ url('supplier') }}" method="post">
            	{{ csrf_field() }}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text"  name="company"  required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">水的种类</label>
                <div class="col-md-6 col-sm-9 col-xs-12">
                	<input type="text"  name="goods_type"  required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
